...
export const competitions: Competition[] = [
  ...
  // Scraped-style sample events
  {
    id: 'evt-balestrand-2025',
    name: 'Balestrand Opp og Rundt 2025',
    date: '2025-09-06',
    startTime: '13:30',
    location: 'Balestrand, NOR',
    organizer: 'Balestrand IL',
    homepage: 'https://balestrandopp.com/',
    sport: 'Annet',
    level: 'Ingen',
    signupBegin: '2025-01-02T00:00:00',
    signupEnd: '2025-09-06T13:00:00',
    races: [
      { name: 'Balestrand Opp og Rundt Konkurranse', startTime: '13:30' },
    ],
    premium: true,
    enrolledCount: 120,
  ...
  {
    id: 'evt-numedalslopet-2025',
    name: 'Numedalsløpet 2025',
    date: '2025-09-06',
    location: 'Flesberg, NOR',
    organizer: 'Svene IL',
    homepage: 'https://www.svene.no/WPPillot/numedalslopet/',
    sport: 'Terrengløp',
    level: 'Nasjonalt stevne',
    races: [
      { name: 'Numedalsløpet', startTime: '00:00' },
    ],
    premium: false,
    enrolledCount: 220,
    imageUrl: 'https://images.unsplash.com/photo-1520975602119-4954a7c9abf8?q=80&w=1200&auto=format&fit=crop',
  },
]
